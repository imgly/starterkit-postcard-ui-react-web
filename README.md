...
A comprehensive postcard editor built with CE.SDK and React, featuring a step-by-step workflow for creating personalized greeting cards.
...
│   │   ├── contexts/          # App-specific contexts (EditorContext, PageSettingsContext)
│   │   ├── ui/                # 50+ Reusable UI components
│   │   ├── icons/             # SVG icon components
│   │   ├── PostcardUI/        # Main UI component
│   │   ├── ChooseTemplateStep/
│   │   ├── PageToolbar/       # Front/back page toolbars
│   │   ├── ProcessNavigation/ # Step navigation
│   │   └── App.tsx            # Root component
│   │
│   ├── imgly/                 # CE.SDK integration layer
│   │   ├── contexts/          # Engine contexts (EngineContext, SinglePageModeContext, SelectionContext)
│   │   ├── hooks/             # Custom hooks (UseEditMode, UseHistory, UseImageUpload, etc.)
│   │   ├── utils/             # Utility functions (ColorUtilities, CreativeEngineUtils, UnsplashSource)
│   │   ├── index.ts           # Public API exports
│   │   └── postcard-catalog.ts # Template definitions
│   │
